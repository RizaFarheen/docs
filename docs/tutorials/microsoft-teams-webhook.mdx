...
description: "Learn how to receive Microsoft Teams webhook messages and trigger workflows to generate structured tickets."
---
...
In the **JQ expression**, replace `<YOUR-TEAMS-WEBHOOK-NAME>` with your Microsoft Teams webhook name and save the workflow.
...
1. In the channel where you added the outgoing webhook, enter:
