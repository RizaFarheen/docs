...
description: "Learn how to build a loan origination workflow that processes loan applications and orchestrates approval steps."
---
...
- Based on conditions:
    ...
    - If the loan amount exceeds $10,000, the application is sent for manual review.
...
```json
{
 ...
 "integrations": [
   "<YOUR-LLM-PROVIDER>:<YOUR-LLM-MODEL>"
 ],
 "version": 1
}
```
