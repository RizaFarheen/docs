...
description: "Learn the workflow and task statuses in Orkes Conductor and how they represent execution states such as RUNNING, COMPLETED, FAILED, and other task lifecycle transitions."
---
