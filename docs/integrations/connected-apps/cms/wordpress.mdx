...
| --------- | ----------- | ---------------------------- | 
| Get Me | Get the current authenticated user profile.  | auth | 
| Create Post | Create a new post or page. | posts | 
| Update Post | Update an existing post or page. | posts |
| Delete Post | Delete a post or page by ID. | posts |
| Get Post | Get a specific post or page by ID. | posts |
| List Posts | List posts or pages with optional filters. | posts |
| List Tags | List tags in WordPress site. | taxonomy |
| List Categories | List all categories from WordPress site.. | taxonomy |
| Upload Media | Upload a media file to WordPress from a URL. | media |
| Get Media | Get a specific media item by ID. | media |
| List Media | List all media items. | media |
