...
| --------- | ----------- | ---------------------------- |
| Share File | Share a file with a user. | <ul><li>Full Access</li><li>File Access</li></ul> |
| Move File | Move a file to another folder. | <ul><li>Full Access</li><li>File Access</li></ul> |
| Upload File From Base64 | Upload a file from base64-encoded content into Google Drive. | <ul><li>Full Access</li><li>File Access</li></ul> |
| Download File Base64 | Download a file's content as base64 by file ID.  | <ul><li>Full Access</li><li>File Access</li><li>Read Only</li></ul> |
| Create Folder |  Create a folder in Google Drive, optionally under a parent folder. | <ul><li>Full Access</li><li>File Access</li></ul> |
| Create Google Doc | Create a Google Doc with a title and plain text content. | <ul><li>Full Access</li><li>File Access</li></ul> |
| Create File From Text | Create a new file in Drive from plain text content. | <ul><li>Full Access</li><li>File Access</li></ul> |
| Search Files and Folders | Search files and folders in Google Drive. | <ul><li>Full Access</li><li>File Access</li><li>Read Only</li></ul> |
| Delete Folder | Delete a folder by ID. | <ul><li>Full Access</li><li>File Access</li></ul> |
| Share Folder | Share a folder with a user. | <ul><li>Full Access</li><li>File Access</li></ul> |
| Create Shared Drive | Create a shared drive. | <ul><li>Full Access</li></ul> |
| Delete Shared Drive | Delete a shared drive. | <ul><li>Full Access</li></ul> |
| Get Shared Drive | Retrieve a shared drive by ID. | <ul><li>Full Access</li><li>Read Only</li></ul> |
| Get Many Shared Drives | List shared drives available to the user. | <ul><li>Full Access</li><li>Read Only</li></ul> |
| Update Shared Drive | Update shared drive metadata. | <ul><li>Full Access</li></ul> |
| Update File | Update a file's metadata or content. | <ul><li>Full Access</li><li>File Access</li></ul> |
| Delete File | Delete a file by file ID. | <ul><li>Full Access</li><li>File Access</li></ul> |
| List Files | Lists files from Google Drive matching the query. | <ul><li>Full Access</li><li>File Access</li><li>Read Only</li></ul> |
| Copy File | Copy a file in Google Drive. | <ul><li>Full Access</li><li>File Access</li></ul> |
