...
| --------- | ----------- | ---------------------------- |
| Create Document | Create a new Google Doc with a title and content. | <ul><li>Read & Write</li></ul> | 
| Replace Text | Find and replace all occurrences of target text in a Google Doc. | <ul><li>Read & Write</li></ul> | 
| Get Document | Fetch a Google Doc by ID, including structure and content metadata. | <ul><li>Read & Write</li><li>Read Only</li></ul> | 
| Update Document | Replace all document content with new text. | <ul><li>Read & Write</li></ul> | 
| Append Text | Append text to the end of an existing Google Doc. | <ul><li>Read & Write</li></ul> | 
