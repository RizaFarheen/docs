...
description: "Learn how to integrate Git repositories such as GitHub, GitLab, or Bitbucket so workflows can securely access files using API tokens."
---
...
You can also integrate any repository that supports API token.
