...
description: "Learn how to configure Google Cloud integration so workflows can securely access private Cloud Storage buckets using storage-related tasks."
---
