...
description: "Learn how to integrate NATS so workflows can publish and receive events through NATS messaging systems."
---
...
| Select security protocol | The security protocol for authenticating the connection. Supported values: <ul><li>**NONE**</li><li>**JWT**–If selected, upload the **JWT Credentials file**.</li><li>**TOKEN_BASED_AUTHENTICATION**–If selected, obtain the JWT token from your NATS server using API.</li></ul> | Required. | 
