---
slug: "/sdks/java"
description: "Learn how to use the Conductor Java SDK to build and run orchestrated applications."
---
...
Write your workflow file. Create `src/main/java/GreetWorker.java`:
