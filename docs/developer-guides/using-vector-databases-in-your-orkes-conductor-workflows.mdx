...
description: "Learn how to integrate vector databases and use them with AI tasks to store and retrieve embeddings in workflows."
---
...
3. For Weaviate, select **+ New Collection**.
4. Enter the index or collection name and an optional description. 
