...
description: "Learn how to integrate AI models and use LLM system tasks in workflows, including configuring models, prompt templates, and access control."
---
...
If you are using an [LLM Text Complete](../reference-docs/ai-tasks/llm-text-complete) task, an AI prompt is required. For [LLM Chat Complete](../reference-docs/ai-tasks/llm-chat-complete), a prompt is optional. You can create a prompt in the AI Prompt Studio to be used with AI tasks in a workflow. Refer to [Using AI Prompts](creating-and-managing-gen-ai-prompt-templates) for more information.
...
Check out the quickstart template on Developer Edition for building an [agentic research assistant](/templates/agentic-research) that uses multiple prompts.
