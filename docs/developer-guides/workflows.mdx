...
description: "Learn how workflows are defined in Orkes Conductor, including workflow definitions, parameters, and different ways to create workflows using code, APIs, or visual tools."
---
...
1. **Code**: Using Conductor SDKs, define the workflow in any programming language (Python, Java, JavaScript, C#, Go) and register it with the Conductor server. Once registered, Conductor generates and saves the JSON workflow definition. Learn more in [Write Workflows as Code](/content/developer-guides/write-workflows-using-code).
