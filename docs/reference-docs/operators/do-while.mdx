...
description: "Learn how the Do While task repeatedly executes a sequence of tasks while a specified condition remains true."
---
...
<Tabs>
<TabItem value="Using Set Variable task (recommended)" label="Using Set Variable task (recommended)">
...
<TabItem value="Using the base task reference name" label="Using the base task reference name">
...
<TabItem value="Referencing a specific iteration" label="Referencing a specific iteration">
